...
export const LISTENING_SECTIONS: ListeningSection[] = [
  ...
  },
  {
    ...
    types: [
      ...
      { id: "s2_summary_flowchart", name: "Summary / Flow-chart Completion", description: "Fill words into summary or process diagram", frequency: "low" },
  ...
  },
  {
    ...
    types: [
      ...
      { id: "s3_short_answer", name: "Short-Answer Questions", description: "Answer in 1-3 words about academic discussion topics", frequency: "low" },
  ...
  },
  {
    ...
    types: [
      ...
      { id: "s4_short_answer", name: "Short-Answer Questions", description: "Answer in 1-3 words from lecture content", frequency: "low" },
