...
import { ListeningIllustration } from "@/components/ui/module-illustrations";
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="relative overflow-hidden rounded-2xl p-6" style={{
        background: "linear-gradient(135deg, #1a3a5c 0%, #378ADD 60%, #5ba3e6 100%)",
      }}>
        ...
        <div className="relative z-10 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-white">Listening Records</h1>
      ...
      {records.length === 0 ? (
        <div className="card-base p-12 text-center">
          <ListeningIllustration className="w-48 h-36 mx-auto mb-2" />
