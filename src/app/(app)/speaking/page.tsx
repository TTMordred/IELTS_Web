  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="relative overflow-hidden rounded-2xl p-6" style={{
        background: "linear-gradient(135deg, #0e5c42 0%, #1D9E75 60%, #3fbf95 100%)",
      }}>
        ...
        <div className="relative z-10 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-white">Speaking Records</h1>
      ...
      {entries.length === 0 ? (
        <div className="card-base p-12 text-center">
          <SpeakingIllustration className="w-48 h-36 mx-auto mb-2" />
